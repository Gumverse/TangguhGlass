					...
					<div className={`row justify-content-center ${styles.ctaRowMargin}`}>
						<div className="col-lg-10 text-center">
							<h2 className="mb-3" style={{ fontWeight: 800, color: "#e63946" }}>
								Jangan Lewatkan! Hanya Hari Ini, Konsultasi & Penawaran Kaca Patri Eksklusif
							</h2>
							<p className="mb-4" style={{ fontSize: "1.2rem" }}>
								Jadikan ruangan Anda pusat perhatian dengan kaca patri custom dari Tangguh Glass. Stok dan jadwal produksi sangat terbatas! Klik tombol di bawah untuk konsultasi GRATIS dan dapatkan penawaran spesial sebelum kehabisan slot bulan ini.
							</p>
							<div className="aximo-bottom-center">
								<a
									className="aximo-default-btn green-btn pill"
									href="https://wa.me/6285718833106?text=Halo%2C%20saya%20ingin%20mendapatkan%20penawaran%20spesial%20dan%20konsultasi%20gratis%20untuk%20kaca%20patri%20di%20Tangguh%20Glass.%20Mohon%20info%20jadwal%20dan%20detail%20produknya."
									target="_blank"
								...
								>
									...
									&nbsp;&nbsp;Konsultasi & Pesan Sekarang via WhatsApp
								</a>
							</div>
						</div>
					</div>
